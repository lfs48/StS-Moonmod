...
public class CorruptionV2Power extends BasePower {

    public boolean upgraded;
    public static final String POWER_ID = "CorruptionV2";
    private static final AbstractPower.PowerType TYPE = AbstractPower.PowerType.BUFF;
    private static final boolean TURN_BASED = false;

    public CorruptionV2Power(AbstractCreature owner, int amount) {
