...
public class ChooseFreeCardAction extends AbstractGameAction {
  ...
  public ChooseFreeCardAction() {
    this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
    this.duration = Settings.ACTION_DUR_FAST;
    this.amount = 1;
  }
  
  public ChooseFreeCardAction(AbstractCard.CardType type, int amount) {
    this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
    this.duration = Settings.ACTION_DUR_FAST;
    this.amount = amount;
    this.cardType = type;
  ...
  public ChooseFreeCardAction(boolean colorless, int amount) {
    this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
    this.duration = Settings.ACTION_DUR_FAST;
    this.amount = amount;
  ...
  public ChooseFreeCardAction(AbstractCard.CardType type, boolean colorless, int amount) {
    this.actionType = AbstractGameAction.ActionType.CARD_MANIPULATION;
    this.duration = Settings.ACTION_DUR_FAST;
    this.amount = amount;
    this.cardType = type;
