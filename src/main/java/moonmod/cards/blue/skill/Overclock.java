...
public class Overclock extends BaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction)new DrawCardAction(this.magicNumber, (AbstractGameAction)new MillAction(p, p, MILL_AMOUNT)));
      }
