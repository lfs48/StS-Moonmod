package moonmod.cards;

import basemod.abstracts.CustomCard;
import moonmod.MoonMod;
import moonmod.util.CardInfo;

import static moonmod.MoonMod.makeID;
import static moonmod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    MoonMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
